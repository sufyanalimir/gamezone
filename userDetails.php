...
<?php
    ...
    if(isset($_POST['viewScore'])){
        ...
        echo"<br><br>
            <form action='' method='POST'>
                ...
                <label>Name</label><input type='text' name='uname' value='$res[0]'>
                <label>Password</label><input type='password' name='prd' value='$res[1]'>
    ...
    echo"<br><br>
        <table cellspacing=20>
            <tr><th colspan=2>FastTap</th></tr>
            <tr><th>time</th><th>score</th></tr>
    ";
    ...
    echo"<br><br>
    <table cellspacing=20>
        <tr><th colspan=3>FastTap</th></tr>
        <tr><th>difficulty</th><th>time</th><th>score</th></tr>
    ";
